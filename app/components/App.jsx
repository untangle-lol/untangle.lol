...
const LANGS = [
  ...
  woop:"🎯 WOOP ausprobieren",woopTitle:"WOOP-Methode",woopSub:"Eine bewährte Technik, um Wünsche in Handlungen umzuwandeln — Schritt für Schritt.",woopLabels:["Wunsch","Ergebnis","Hindernis","Plan"],woopHints:["Was willst du wirklich? Wähle etwas Bedeutungsvolles — herausfordernd, aber erreichbar.","Stell dir das beste Ergebnis vor. Wie fühlst du dich, wenn dein Wunsch in Erfüllung geht?","Was ist das größte innere Hindernis — eine Gewohnheit, ein Gefühl oder ein Gedanke — das dich aufhalten könnte?","Wenn [Hindernis], dann werde ich [Aktion]. Mach einen konkreten Wenn-dann-Plan."],woopPh:["Z.B. 'Ich möchte jeden Morgen Sport machen'","Z.B. 'Ich fühle mich energiegeladen und stolz auf mich'","Z.B. 'Ich drücke auf Snooze, weil ich müde bin'","Z.B. 'Wenn ich auf Snooze drücke, lege ich meine Sportsachen am Abend vorher bereit'"],woopGo:"Meinen Plan erstellen →",woopSummaryTitle:"Dein WOOP"},
  ...
  woop:"🎯 Probar WOOP",woopTitle:"Método WOOP",woopSub:"Una técnica probada para convertir deseos en acciones — paso a paso.",woopLabels:["Deseo","Resultado","Obstáculo","Plan"],woopHints:["¿Qué deseas realmente? Elige algo significativo — desafiante pero alcanzable.","Imagina el mejor resultado posible. ¿Cómo te sientes cuando tu deseo se hace realidad?","¿Cuál es el principal obstáculo interno — un hábito, sentimiento o pensamiento — que podría frenarte?","Si [obstáculo], entonces haré [acción]. Crea un plan concreto si-entonces."],woopPh:["Ej. 'Quiero hacer ejercicio cada mañana'","Ej. 'Me siento lleno de energía y orgulloso de mí mismo'","Ej. 'Apago la alarma porque estoy cansado'","Ej. 'Si apago la alarma, prepararé mi ropa de deporte la noche anterior'"],woopGo:"Crear mi plan →",woopSummaryTitle:"Tu WOOP"},
    ...
    {(vw==="home"||vw==="new_goal")&&auth!=="in"&&(
      <div dir={dir} style={sx.pg}><div style={sx.w}>
        ...
        <div style={{...sx.cd,position:"relative"}}>
          ...
          <button onClick={()=>{setErr(null);setWoopData({wish:"",outcome:"",obstacle:"",plan:""});setWoopStep(0);setVw("woop_input");}} style={{...sx.bg,marginTop:8,display:"flex",alignItems:"center",justifyContent:"center",gap:6}}>{t.woop||"🎯 Try WOOP"}</button>
          <Err/>
        </div>
