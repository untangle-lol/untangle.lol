  ...
  return(<>
    ...
    {(vw==="home"||vw==="new_goal")&&auth!=="in"&&(
      <div dir={dir} style={sx.pg}><div className="uw" style={sx.w}>
        ...
        <div style={{textAlign:"center",marginTop:10}}><a className="donate-txt" href="https://bunq.me/BachSoftware" target="_blank" rel="noreferrer" style={{fontSize:13,color:"#c9a227",textDecoration:"underline",textDecorationColor:"rgba(201,162,39,0.4)",textUnderlineOffset:"3px",fontWeight:600,display:"inline-flex",alignItems:"center",gap:4,cursor:"pointer"}} onMouseEnter={e=>e.currentTarget.style.textDecorationColor="#c9a227"} onMouseLeave={e=>e.currentTarget.style.textDecorationColor="rgba(201,162,39,0.4)"}><svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor" style={{display:"block",flexShrink:0}}><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>{t.donateMsg||"Your donation makes the world a little better"}</a></div>
        {auth!=="in"&&(
          <div style={{marginTop:20,textAlign:"center"}}>
