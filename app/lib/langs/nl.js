const nl = {
  ...
  altruismPopupMsg:"Je doel gaat over het helpen van anderen — zoals vrijwilligerswerk, mantelzorg of een goed doel. Dat verdient een beloning: rond álle stappen af en ontvang automatisch 2 gratis vragen!",
  altruismPopupBtn:"Top, ik ga aan de slag!",
  altruismBonusTitle:"+2 vragen verdiend!",
  altruismBonusMsg:"Gefeliciteerd! Je hebt je altruïstische doel afgerond. Als dank voor je inzet voor anderen hebben we 2 gratis vragen aan je account toegevoegd.",
  altruismBonusBtn:"Super, bedankt!",
  altruismTeaser:"Als je iets doet voor een ander verdien je 2 gratis vragen.",
